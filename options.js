...
const saveOptions = () => {
    ...
    chrome.storage.sync.set(
      { type: type, spacekey: spacekey, defspace: defspace, rooturl: rooturl, limit: limit, advancedsearch:advancedsearch },
      () => {
  ...
  const restoreOptions = () => {
    chrome.storage.sync.get(
      {type: 'page',defspace: 's', spacekey: '',rooturl:'', limit:25, advancedsearch: false },
      (items) => {
